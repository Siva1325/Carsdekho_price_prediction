...
st.image('C:\\Users\\Nandhini Sivaramanan\\capstone-project\\CarDekho_capstone\\CarDekho-FY22-social.jpg', caption="Cardekho_prediction", use_column_width=True)
...
def app():
    ...
    def data():
        ...
        df = df.sort_values(by='Registration_Year', ascending=True)
        return df,df1
    df,df1 = data()
